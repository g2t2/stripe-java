...
public class ApplePayDomainService extends ApiService {
  ...
  public ApplePayDomain delete(String id, ApplePayDomainDeleteParams params)
      throws StripeException {
    return delete(id, params, (RequestOptions) null);
  }

  /** Delete an apple pay domain. */
  public ApplePayDomain delete(String id, ApplePayDomainDeleteParams params, RequestOptions options)
      throws StripeException {
    String url = resourceUrl("/v1/apple_pay/domains/%s", id);
