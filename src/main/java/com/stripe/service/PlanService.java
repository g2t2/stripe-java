...
public class PlanService extends ApiService {
  ...
  public Plan update(String id, PlanUpdateParams params, RequestOptions options)
    ...
    String url = resourceUrl("/v1/plans/%s", id);
  ...
  public Plan delete(String id, PlanDeleteParams params) throws StripeException {
    return delete(id, params, (RequestOptions) null);
  }

  /** Deleting plans means new subscribers can’t be added. Existing subscribers aren’t affected. */
  public Plan delete(String id, PlanDeleteParams params, RequestOptions options)
      throws StripeException {
    String url = resourceUrl("/v1/plans/%s", id);
