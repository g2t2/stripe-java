...
public class ValueListItemService extends ApiService {
  ...
  public ValueListItem delete(String id, ValueListItemDeleteParams params) throws StripeException {
    return delete(id, params, (RequestOptions) null);
  }

  /** Deletes a <code>ValueListItem</code> object, removing it from its parent value list. */
  public ValueListItem delete(String id, ValueListItemDeleteParams params, RequestOptions options)
      throws StripeException {
    String url = resourceUrl("/v1/radar/value_list_items/%s", id);
